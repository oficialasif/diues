        ...
        <?php elseif ($action === 'add' || $action === 'edit'): ?>
            ...
            <div class="bg-gray-800 bg-opacity-50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
                ...
                <form method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        <label for="image" class="block text-sm font-medium text-gray-300 mb-2">Profile Photo</label>
                        ...
                        <p class="text-sm text-gray-400 mt-1">Recommended: 400x400 pixels, JPG/PNG/GIF</p>
                    </div>
